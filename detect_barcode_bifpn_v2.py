...
def parse_opt():
    ...
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "checkpoint/exp119/weights/best.pt", help="model path or triton URL")
    ...
    parser.add_argument("--tilt", type=bool, default=True, help="qrcode tilt or not")
